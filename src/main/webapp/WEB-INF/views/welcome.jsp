...
<body>
	<div
		...
		<div class="container">
			...
			<div style="text-align: center; padding: 20px;">
				<font style="font-size: 24px;">Selamat Datang Ke</font><br />
				<br /> <font style="font-size: 24px;">"Sistem Pengurusan
					Taman Medan Cahaya, Fasa 2, PJ."</font>
			</div>
			<div>
				<div
					style="border: solid 1px black; float: left; width: 330px; height: 300px; margin-left: 50px; padding: 10px;">
					<h2>Pungumuman</h2>
					<marquee onmouseover="stop()" onmouseout="start()"
						behavior="scroll" direction="up" scrollamount="2">
						<strong>Date: </strong> 18/05/2012<br> <strong>To: </strong>
						All student<br> <strong>From: </strong> Pengetua Kolej<br>
						<strong>Title: </strong> Send a Free Gift to a Friend:<br> <strong>Description:
		...
		<div class="container">
			<div style="margin-top: 10px; padding-top: 10px;">
				<div
					style="border: solid 1px black; float: left; width: 900px; height: 100px; padding: 10px;">
					<h2>Hubungi Kami:</h2>
					<table>
						<tr>
	...
	<script type="text/javascript"
		src="<c:url value="/resources/js/jquery-1.8.0.js" />"></script>
	<script type="text/javascript"
