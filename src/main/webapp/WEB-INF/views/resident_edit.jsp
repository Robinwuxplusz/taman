...
<div class="container">
	<h1 align="center" class="page_title" >
		<fmt:message key="rs.title.edit"></fmt:message>
	</h1>
	<form class="form-horizontal custom_form" action="${ctx}/resident/edit" method="post">
		<fieldset>
			<div class="control-group">
				<label class="control-label" for="input01"><fmt:message key="rs.room.no"></fmt:message> </label>
				<div class="controls">
					<input type="text" class="input-large" id="input01" value="10001" readonly="readonly">
				</div>
			</div>
			<div class="control-group">
